...
unsigned long end_time = millis();                                     unsigned long curr_total_time = end_time - start_time;
     ...
     Serial.println("12,27,"+String((float)a0_mus[i],5)+","+String((float)a1_mus[i],5) + "," + String((float)rmse_i,5) + "," + String((float)curr_





) + "," +String(NUM_ITERS) + "," + String(NUM_SAMPLES) + "," + String(NUM_DATA_SAMPLES));
