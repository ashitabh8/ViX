...
int main(int argc, char ** argv)//[ARD:SETUP_DEF]
{
    ...
    for(int curr_exp = 0; curr_exp < num_experiments; curr_exp++)
    {
        ...
        // std::cout << "Predicted positions, true positions: " << std::endl;
        // for(int i = 0; i < predicted_positions.size(); i++)
        // {
        //     std::cout << predicted_positions_float[i] << ", "<<true_positions[i]<<std::endl;
        // }

        float rmse_i = rmse(true_positions, predicted_positions_float,50);
        float geomean_i = geomean(true_positions, predicted_positions_float,50);
        ...
        // if (rmse_i > 1)
        // {
        //     std::cout << "RMSE too high, exiting" << std::endl;
        //     break;
        // }
